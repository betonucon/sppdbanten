...
<div class="pad margin no-print">
    <div class="callout callout-info" style="margin-bottom: 0!important;">
        ...
        <h2 style="display:inline"><img src="{{url('public/img/serang.png')}}" width="30px" height="40px"> SURAT TUGAS /# {{$data->nomor_surat}}</h2>
    </div>
</div>
<section class="invoice">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <img src="{{url('public/img/'.cekjasaperjalanan($data->jasa_perjalanan_id)->icon_gambar)}}" width="48px" height="32px" alt="{{cekjasaperjalanan($data->jasa_perjalanan_id)->name}}">
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <button type="button" class="btn btn-success " onclick="cetak_lampiran({{$data->id}})"><i class="fa fa-print"></i> Cetak Lampiran Surat Tugas</button>
...
<script>
    ...
    function cetak_sppd(a){
        window.open("{{url('/surat_tugas/pdf/sppd/')}}/"+a,"_blank");
    }
    function cetak_lampiran(a){
        window.open("{{url('/surat_tugas/pdf/lampiran/')}}/"+a,"_blank");
    }

    function cetak_spt(a){
        window.open("{{url('/surat_tugas/pdf/spt/')}}/"+a,"_blank");
    }
  $(function () {
    $('#example1').DataTable({
      'paging'      : true,
