                        ...
                        <tbody>
                            @foreach($employe as $no=>$employe)
                                <tr>
                                    ...
                                    <td>{{$employe->nip}}</td>
                                    <td>{{$employe->name}}</td>
                                    <td>{{cek_jabatan($employe->jabatan_id)['name']}}</td>
                                    <td>{{$employe->pangkat}}</td>
                                    <td>
                                    @if(permision_pengaturan(Auth::user()->role_id)=='3' || permision_pengaturan(Auth::user()->role_id)=='2')
                                        <div class="btn-group">
        ...
        <div class="modal-content">
            ...
            @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Pangkat:</label>
                        <input type="text" class="form-control" id="pangkat" value="{{$modalpegawai->pangkat}}" name="pangkat">
                    </div>
