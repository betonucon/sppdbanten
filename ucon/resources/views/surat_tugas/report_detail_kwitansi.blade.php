...
function cari_data(){
    ...
    window.location.assign("{{url('/surat_tugas/report_detail_kwitansi/ok')}}?mulai="+mulai+"&sampai="+sampai);
}
...
function print(){
    var mulai=$('#datepicker1').val();
    var sampai=$('#datepicker2').val();
    window.open("{{url('/surat_tugas/pdf/report_detail_kwitansi')}}?mulai="+mulai+"&sampai="+sampai,"_blank");
}
