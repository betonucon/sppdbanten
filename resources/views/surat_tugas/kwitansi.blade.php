                        ...
                        <tbody>
                            @foreach($data as $no=>$data)
                                <tr>
                                    ...
                                    <td><span  data-toggle="modal" data-keyboard="false" data-backdrop="static" data-target="#modalreplay{{$data->id}}" class="btn btn-default btn-sm"><i class="fa fa-pencil"></i></span></td>
...
function close_notif(){
    window.location.assign("{{url('/surat_tugas/kwitansi/ok')}}");
}
function print(){
...
function cetak_spm(a){
    window.location.assign("{{url('/surat_tugas/pdf/kwitansi_spm/')}}/"+a);
}
function cetak_rpbd(a){
    window.location.assign("{{url('/surat_tugas/pdf/kwitansi_rpbd/')}}/"+a);
}
function detail(a){
