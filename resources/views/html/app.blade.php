...
<head>
  ...
  <style>
    #loading {
          ...
          height: 100%;
          z-index: 9999;
          background: url({{url('/img/loading.gif')}}) 50% 50% no-repeat #fff;
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{url('/img/akun.png')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{Auth::user()->name}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{url('/img/akun.png')}}" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{url('/img/serang.png')}}" class="img-circle" alt="User Image">
        </div>
    ...
    <section class="content-header" style="margin-top:4%;width: 100%;">
      <div class="alert alert-default alert-dismissible" style="margin-bottom:0px;margin-top:10px;padding:7px 7px 7px 12px;background: white;border: solid 1px #d5d5de;">
          ...
          <ol class="breadcrumb" style="float: right;background: #fff;color: #000;">
            <li><a href="{{url('/')}}" style="color:#565353"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="{{url('/'.$url)}}" style="color:#565353">{{$page}}</a></li>
