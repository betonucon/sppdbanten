    ...
    <body>
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="tdrs"><br>Rp.{{uang(transportasi($data->id)*$data->selisih)}}<br>Rp.{{uang(harga_tiket($data->id))}}</td>
                    <td class="tdrs"></td>
                </tr>
                <tr>
                    <td class="tdrs">2.</td>
                    <td class="tdrs"><b>Uang Penginapan</b><br>{{$data->selisih}} X {{uang(uang_penginapan($data->id))}}</td>
                    <td class="tdrs">Rp.{{uang(uang_penginapan($data->id))}}<br>Rp.{{(uang(uang_penginapan($data->id)*$data->selisih))}}</td>
                    <td class="tdrs"></td>
                </tr>
                <tr>
                    <td class="tdrs" colspan="2" align="center"><b>Jumlah</b></td>
                    <td class="tdrs">Rp.{{uang((uang_penginapan($data->id)*$data->selisih)+(transportasi($data->id)*$data->selisih)+(harga_tiket($data->id)))}}</td>
                    <td class="tdrs"></td>
                </tr>
                <tr>
            ...
            <table width="100%">
                ...
                <tr>
                    <td width="50%" class="tdr" align="center">Telah Dibayarkan Sejumlah<br><b>Rp.{{uang((uang_penginapan($data->id)*$data->selisih)+(transportasi($data->id)*$data->selisih)+(harga_tiket($data->id)))}}</b></td>
                    <td class="tdr" align="center">Telah Menerima Jumlah Uang Sebesar<br><b>Rp.{{uang((uang_penginapan($data->id)*$data->selisih)+(transportasi($data->id)*$data->selisih)+(harga_tiket($data->id)))}}</b></td>
                </tr>
            </table><br><br>
            <table width="100%">
                <tr align="center">
