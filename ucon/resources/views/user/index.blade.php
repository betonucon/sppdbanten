...
<div class="modal fade" id="modalapp{{$modalpegawai->id}}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- <form method="post" action="{{url('/user/save/'.$modalpegawai->id)}}" enctype="multipart/form-data"> -->
            @csrf
                <input type="hidden" name="id" value="{{$modalpegawai->id}}">
                ...
                <div class="modal-body">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td class="ttd"><input type="checkbox" value="{{$routs->id}}" {{$check->shift()['check']}} name="route_id{{$modalpegawai->id}}[{{$routs->id}}]"></td>
                            <td class="ttd">{{$routs->name}}</td>
                            <td class="ttd">
                                <select name="permision_id{{$modalpegawai->id}}[{{$routs->id}}]">
